...
from adapter.configs.paths_config import caption_paths
...
class ImagesTextDataset(Dataset):
    ...
    def __init__(self, source_root, target_root, opts, target_transform=None, source_transform=None, train=True):
        ...
        self.train = train
        if train:
            self.text_paths_dir = caption_paths['my_data_captions_train']
        else:
            self.text_paths_dir = caption_paths['my_data_captions_test']
