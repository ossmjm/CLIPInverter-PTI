...
from adapter.configs.paths_config import model_paths
...
class TrainOptions:
	...
	def initialize(self):
		...
		self.parser.add_argument('--is_training_from_stage_one', default=False, action="store_true", help='Whether to continue training or use the model for inference')
		...
		self.parser.add_argument('--checkpoint_path', default=None, required=True, type=str, help='Path to the first stage model checkpoint')
